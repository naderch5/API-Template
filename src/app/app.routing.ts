...
const routes: Routes =[
    ...
    {path: 'creditR/:id', component: CreditREditComponent},
    {path: 'recoveries', component: RecoveryShowComponent},
    {path: 'creditsr', component: CreditRShowComponent},
    {path: 'recovery/:id', component: RecoveryEditComponent},
